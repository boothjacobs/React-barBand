...
module.exports = {
  up: (queryInterface, Sequelize) => {
      ...
      return queryInterface.bulkInsert('Songs', [
        ...
        {title: "State of Grace", artistId: 17, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Provide+-+ReRed+-+01+State+of+Grace.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Red", artistId: 18, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/I+Wish+I+Could+Skateboard+-+ReRed+-+02+Red.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Treacherous", artistId: 4, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/ManDancing+(feat.+Sun+Cycles)+-+ReRed+-+03+Treacherous.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "I Knew You Were Trouble", artistId: 12, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Gabe+Goodman+-+ReRed+-+04+I+Knew+You+Were+Trouble.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "All Too Well", artistId: 19, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Dan+Campbell+-+ReRed+-+05+All+Too+Well.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "22", artistId: 20, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Bad+Bad+Hats+-+ReRed+-+06+22.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "I Almost Do", artistId: 14, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Photocomfort+-+ReRed+-+07+I+Almost+Do.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "We Are Never Ever Getting Back Together", artistId: 16, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Wild+Pink+-+ReRed+-+08+We+Are+Never+Ever+Getting+Back+Together.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Stay Stay Stay", artistId: 15, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Tuft+%26+Lake+Saint+Daniel+-+ReRed+-+09+Stay+Stay+Stay.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "The Last Time", artistId: 21, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Mint+Green+-+ReRed+-+10+The+Last+Time.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Holy Ground", artistId: 22, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Chris+Farren+-+ReRed+-+11+Holy+Ground.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Sad Beautiful Tragic", artistId: 11, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Happy+Just+to+See+You+-+ReRed+-+12+Sad+Beautiful+Tragic.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "The Lucky One", artistId: 23, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Weakened+Friends+-+ReRed+-+13+The+Lucky+One.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Everything Has Changed", artistId: 13, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Hit+Like+a+Girl+%26+Good+Looking+Friends+-+ReRed+-+14+Everything+Has+Changed.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Starlight", artistId: 24, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Adult+Mom+-+ReRed+-+15+Starlight.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Begin Again", artistId: 2, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Future+Teens+-+ReRed+-+16+Begin+Again.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "The Moment I Knew", artistId: 25, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Paige+Chaplin+-+ReRed+-+17+The+Moment+I+Knew.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Come Back... Be Here", artistId: 26, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Telethon+-+ReRed+-+18+Come+Back...Be+Here.mp3", createdAt: new Date(), updatedAt: new Date() },
        {title: "Girl at Home", artistId: 27, originalArtist: "Taylor Swift", albumId: 3, fileUrl: "https://barband-seeds.s3.us-east-2.amazonaws.com/Something+Merry+-+ReRed/Calicoco+-+ReRed+-+19+Girl+at+Home.mp3", createdAt: new Date(), updatedAt: new Date() },
